...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 Ashraful Rain 💗
\x1b[1;91m➣ Facebook :  💣 ashrafulrain.original💣
\x1b[1;93m➣  YouTube:   👬 A-RAIN21X BYPS 👬
\x1b[1;95m➣ Tools:  👉  Free Version 🙃
...
def menu():
	...
	print '\033[1;97m[6]\033[1;92m Youtube [Subscribe ]'
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/c/@ashrafulrain1061')
		login()
	elif ahmad =='0':
		exb()
	else:
